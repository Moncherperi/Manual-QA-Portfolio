...
При замене текстового значения цены на максимальное граничное значение `10 000 000` вёрстка карточки товара отображалась корректно согласно условию
...
### 💡 Вывод по задаче
Метод локальной подмены данных через DevTools полностью подтвердил свою эффективность для быстрого тестирования UI/UX ограничений. Вёрстка страницы полностью готова к корректному отображению любых экстремальных значений цен в рамках требований ТЗ.
